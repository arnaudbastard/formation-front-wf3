...
export class AjouterComponent implements OnInit {
  ...
  submitContact() {
    ...
    /**
     * Lorsque le formulaire est soumis, ma fonction submitContact s'exécute.
     * ---
    ...
    // -- Réinitialisaer le formulaire
    this.active = false;
    setTimeout(() => this.active = true, 0);

    /**
     * Explication : je passe mon formulaire à false puis immédiatement à true, ce qui a pour conséquence de le détruire dans le DOM puis le re-créer ...
     */
